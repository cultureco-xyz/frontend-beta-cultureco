...
export default function StripePurchase({
  ...
  const handleCheckout = async () => {
    ...
    const res = await fetch("/backend/payment/stripe/order-tribe", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ cost, creator }), // You can pass dynamic quantity here
    });
  ...
  return (
    ...
    >
      {loading ? "Loading..." : title ? title : "Pay with Stripe"}
    </Button>
  );
}
