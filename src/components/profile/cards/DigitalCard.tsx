...
function DigitalCard({
  ...
  return (
    <svg
      ...
      className={className}
    >
      <g clipPath="url(#clip0_2556_63310)">
        <g filter="url(#filter0_d_2556_63310)">
          <path
            fill="url(#pattern0_2556_63310)"
            d="M0 0h173v240H0z"
            shapeRendering="crispEdges"
          ></path>
        </g>
        <path
          fill="url(#paint0_linear_2556_63310)"
          d="M0 0h173v62H0z"
          transform="translate(0 178)"
        ></path>
      </g>
      <mask id="path-4-inside-1_2556_63310" fill="#fff">
        <path
          fillRule="evenodd"
      ...
      <path
        ...
        mask="url(#path-4-inside-1_2556_63310)"
      ></path>
      <defs>
        <linearGradient
          id="paint0_linear_2556_63310"
          x1="87"
          x2="86.433"
          y1="0"
          y2="61.999"
        ...
        <clipPath id="clip0_2556_63310">
          <rect width="173" height="240" fill="#fff" rx="16"></rect>
        </clipPath>
        <pattern
          id="pattern0_2556_63310"
          width="1"
          height="1"
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_2556_63310"
          ></feBlend>
          <feBlend
            in="SourceGraphic"
            in2="effect1_dropShadow_2556_63310"
            result="shape"
          ></feBlend>
        </filter>
        <image
