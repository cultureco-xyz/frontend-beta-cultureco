...
const DigitalFrame = ({
  ...
  return (
    <svg
      ...
      viewBox="0 0 361 480"
    >
      <mask id="path-1-inside-1_2746_84833" fill="#fff">
        <path
          fillRule="evenodd"
      ...
      <path
        fill="url(#pattern0_2746_84833)"
        fillRule="evenodd"
        d="M0 16v448h4v8h4v4h8v4h329v-4h8v-4h4v-8h4V16h-4V8h-4V4h-8V0H16v4H8v4H4v8z"
        clipRule="evenodd"
      ></path>
      <path
        fill="url(#paint0_linear_2746_84833)"
        fillRule="evenodd"
        d="M0 16v448h4v8h4v4h8v4h329v-4h8v-4h4v-8h4V16h-4V8h-4V4h-8V0H16v4H8v4H4v8z"
        clipRule="evenodd"
      ></path>
      <path
        ...
        mask="url(#path-1-inside-1_2746_84833)"
      ></path>
      <defs>
        <linearGradient
          id="paint0_linear_2746_84833"
          x1="181"
          x2="180.5"
          y1="261.5"
          y2="480"
        ...
        >
          <use
            ...
            transform="matrix(.00192 0 0 .00145 0 -.034)"
          ></use>
        </pattern>
        {image && (
          <image
