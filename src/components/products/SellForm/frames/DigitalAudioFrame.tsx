...
export const DigitalAudioFrame = ({
  ...
  return (
    ...
    >
      <g clipPath="url(#clip0_2746_85260)">
        <g clipPath="url(#clip1_2746_85260)">
          <g filter="url(#filter0_d_2746_85260)">
            <rect width={361} height={317} fill="#D9D9D9" />
            <rect width={361} height={317} fill="url(#pattern0_2746_85260)" />
          </g>
          <rect
            width={360}
            height={163}
          ...
          <rect
            ...
            height={163}
            transform="translate(0 317)"
            fill="url(#pattern1_2746_85260)"
            fillOpacity={0.5}
            style={{ mixBlendMode: "luminosity" }}
          />
        </g>
        <mask id="path-4-inside-1_2746_85260" fill="white">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
        ...
        <path
          ...
          fill="#ECECEC"
          mask="url(#path-4-inside-1_2746_85260)"
        />
      </g>
      <defs>
        <filter
          id="filter0_d_2746_85260"
          x={-15}
          y={-7}
          width={391}
          height={347}
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_2746_85260"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_2746_85260"
            result="shape"
          />
        </filter>
        <pattern
          id="pattern0_2746_85260"
        ...
        <pattern
          id="pattern1_2746_85260"
          patternContentUnits="objectBoundingBox"
          width={1}
          height={1}
        >
          <use
            xlinkHref="#image1_2746_85260"
            transform="matrix(0.00168067 0 0 0.00368928 0 -1.32742)"
          />
        </pattern>
        <clipPath id="clip0_2746_85260">
          <rect width={361} height={480} fill="white" />
        </clipPath>
        <clipPath id="clip1_2746_85260">
